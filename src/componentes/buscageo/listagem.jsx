    ...
    return (
      <div className={this.props.buscaGeo.acervos.length > 0 ? 'resultado-buscageo ativo' : 'resultado-buscageo inativo'} >
        <div className="row buscageo-filtro">
          ...
          <div className='buscageo-mosaico-menu-right'>

            <div className="buscageo-mosaico" title="Gerar mosaico">
              <span onClick={() => this.props.abrirMosaico()} style={{ float: 'right' }}><i className="fa fa-video-camera" title="limpar"></i></span>
            </div>
