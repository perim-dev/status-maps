...
import {SidebarDemo} from '../lista-lateral/sidebar';
...
class BarraDeTitulo extends Component {
  render() {
    return (
      <Col sm={12} md={12} lg={12} className="d-none d-sm-block modulo">
        <Panel className="modulo barra-de-titulo bg-grafite ">
            ...
            <Col xsHidden={true} sm={11} md={11} lg={11} id="linha-marquee">
              <LinhaMarquee texto="Empresa Municipal de Informática" cor="azul" />
